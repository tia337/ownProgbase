...
{
    ui->messageInput->setStyleSheet("background-color: lightgrey;");
    ui->roomTree->setStyleSheet("background-color: lightgrey;");
    ui->messageHistory->setStyleSheet("background-color: lightgrey;");
...
{
    ui->messageInput->setStyleSheet("background-color:  #e8ca7b;");
    ui->roomTree->setStyleSheet("background-color:  #f2d554;");
    ui->messageHistory->setStyleSheet("background-color:  #f2d554;");
    this->setStyleSheet("background-color:  #a4a8a9;");
